...
import { PlannerApplyTypes } from '../../../model/recruits';
import * as S from '../../../components/styles';
import LikeUser from '../../../components/LikeUser';

export interface ApplyProps {
  data: PlannerApplyTypes;
}
...
const PlannerApplyStatus = ({ data }: ApplyProps) => {
  ...
  return (
    <StyledRecruitItem onClick={handleImageClick}>
      ...
      <S.Row $justifyContent="flex-end">
        <S.Button $size="xsmall">{data.totalApplyCount}명 지원</S.Button>
      </S.Row>
    </StyledRecruitItem>
  );
};

export default PlannerApplyStatus;
